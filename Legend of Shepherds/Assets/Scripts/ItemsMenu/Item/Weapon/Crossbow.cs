...
public class Crossbow : Weapon
{
    ...
    public Crossbow(string r, int l) : base(r, l)
    {
        SetAttributes();
    }
    ...
    public override string GetDescription()
    {
        ...
        {
            case "Common":
                title = "<color=#606060ff><b>Crossbow</b></color>   \n";
                break;
            case "Uncommon":
                title = "<color=green><b>Crossbow</b></color>   \n";
                break;
            case "Heroic":
                title = "<color=purple><b>Crossbow</b></color>   \n";
                break;
            case "Legendary":
                title = "<color=yellow><b>Crossbow</b></color>   \n";
                break;
            default:
                title = "<color=gray><b>Crossbow</b></color>   \n";
                break;
        }
