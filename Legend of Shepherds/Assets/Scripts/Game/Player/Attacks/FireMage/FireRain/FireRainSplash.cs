...
public class FireRainSplash : MonoBehaviour {
    ...
    void Start()
    {
        dmg = GameObject.Find("Datas").GetComponent<Datas>().Get_FireRainDamage_Player(1) * GameObject.Find("Datas").GetComponent<Datas>().Get_AdvancementValues(GameObject.Find("Player").GetComponent<Player_Level>().GetLevel());
        dmg += GameObject.Find("Datas").GetComponent<Datas>().Get_FireRainDamage_Player(0) * GameObject.Find("Datas").GetComponent<AttributeCalculator>().Get_MagicPower();
